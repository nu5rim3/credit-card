    ...
    return (
        <div className='flex flex-col'>
            <div className='flex flex-col sm:flex-row'>
                <div className='flex w-full h-[100vh] sm:h-[85vh] text-black'>
                    <div className="bg-[url('/img/hero-pattern.svg')] flex w-full animate-duration-[2000ms] animate-once flex-col sm:flex-row">
                        <div className="hidden w-full sm:w-1/2 sm:flex items-center justify-center">
                            <img src={cardImage} className='animate-fade-up animate-duration-[3000ms] animate-once h-80 sm:h-1/3' />
                        </div>
                        ...
                        {/* <div className="w-full sm:w-1/2 h-full sm:hidden items-center justify-center">
            ...
            <div className="hidden sm:flex sm:h-[10vh] bg-gray-700 text-white animate-fade-up animate-duration-[5000ms] animate-once sm:pt-5">
            ...
            <div className="hidden sm:h-[5vh] bg-gray-900 text-white sm:flex items-center justify-center animate-fade-up animate-duration-[5000ms] animate-once">
