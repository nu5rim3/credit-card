...
const GetStart = () => {
    ...
    return (
        <div className="bg-[url('/img/hero-pattern.svg')] flex justify-center items-center min-h-screen">
            <div className='bg-primary-100/60 p-8 rounded-lg shadow-md w-full my-2 animate-fade-up animate-duration-[1000ms] animate-once flex flex-col justify-between items-center h-screen'>
